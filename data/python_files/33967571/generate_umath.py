...
# TypeDescriptions.
defdict = {#BOHRIUM added a opcore for each ufunc.
'add' :
    Ufunc('BH_ADD',2, 1, Zero,
...
'conjugate' :
    Ufunc('BH_NONE',1, 1, None,
          docstrings.get('numpy.core.umath.conjugate'),
          TD(ints+flts+cmplx),
          TD(P, f='conjugate'),
          ),
'fmod' :
    Ufunc('BH_NONE',2, 1, Zero,
...
'greater' :
    Ufunc('BH_GREATER',2, 1, None,
          docstrings.get('numpy.core.umath.greater'),
          TD(all, out='?'),
          ),
'greater_equal' :
    Ufunc('BH_GREATER_EQUAL',2, 1, None,
          docstrings.get('numpy.core.umath.greater_equal'),
          TD(all, out='?'),
          ),
'less' :
    Ufunc('BH_LESS',2, 1, None,
          docstrings.get('numpy.core.umath.less'),
          TD(all, out='?'),
          ),
'less_equal' :
    Ufunc('BH_LESS_EQUAL',2, 1, None,
          docstrings.get('numpy.core.umath.less_equal'),
          TD(all, out='?'),
          ),
'equal' :
    Ufunc('BH_EQUAL',2, 1, None,
          docstrings.get('numpy.core.umath.equal'),
          TD(all, out='?'),
          ),
'not_equal' :
    Ufunc('BH_NOT_EQUAL',2, 1, None,
          docstrings.get('numpy.core.umath.not_equal'),
          TD(all, out='?'),
          ),
'logical_and' :
    Ufunc('BH_LOGICAL_AND',2, 1, One,
          docstrings.get('numpy.core.umath.logical_and'),
          TD(noobj, out='?'),
          TD(P, f='logical_and'),
          ),
'logical_not' :
    Ufunc('BH_LOGICAL_NOT',1, 1, None,
          docstrings.get('numpy.core.umath.logical_not'),
          TD(noobj, out='?'),
          TD(P, f='logical_not'),
          ),
'logical_or' :
    Ufunc('BH_LOGICAL_OR',2, 1, Zero,
          docstrings.get('numpy.core.umath.logical_or'),
          TD(noobj, out='?'),
          TD(P, f='logical_or'),
          ),
'logical_xor' :
    Ufunc('BH_LOGICAL_XOR',2, 1, None,
          docstrings.get('numpy.core.umath.logical_xor'),
          TD(noobj, out='?'),
          TD(P, f='logical_xor'),
          ),
'maximum' :
    Ufunc('BH_MAXIMUM',2, 1, None,
          docstrings.get('numpy.core.umath.maximum'),
          TD(noobj),
          TD(O, f='npy_ObjectMax')
          ),
'minimum' :
    Ufunc('BH_MINIMUM',2, 1, None,
          docstrings.get('numpy.core.umath.minimum'),
          TD(noobj),
          TD(O, f='npy_ObjectMin')
          ),
'fmax' :
    Ufunc('BH_NONE',2, 1, None,
...
'isnan' :
    Ufunc('BH_ISNAN',1, 1, None,
          docstrings.get('numpy.core.umath.isnan'),
          TD(inexact, out='?'),
          ),
'isinf' :
    Ufunc('BH_ISINF',1, 1, None,
