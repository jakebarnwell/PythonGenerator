...
import transaction
from rtbs.theme.testing import RTBS_THEME_INTEGRATION_TESTING
from rtbs.theme.testing import RTBS_THEME_FUNCTIONAL_TESTING
...
class TestSetup(unittest.TestCase):
    layer = RTBS_THEME_INTEGRATION_TESTING
    def test_css_registry_configured(self):
        portal = self.layer['portal']
        cssRegistry = getToolByName(portal, 'portal_css')
        self.assertTrue(
            "++theme++rtbs.theme/stylesheets/main.css"
            in cssRegistry.getResourceIds()
        )
        self.assertTrue(
            "++theme++rtbs.theme/stylesheets/iefixes.css"
            in cssRegistry.getResourceIds()
        )
...
class TestRendering(unittest.TestCase):
    layer = RTBS_THEME_FUNCTIONAL_TESTING
