...
def is_npy_no_smp():
    ...
    #BOHRIUM - Deactivate SMP support
    return 1;
...
""")
    ...
    #BOHRIUM
    config.add_include_dirs(join('..','..','bohrium','include'))
    multiarray_deps.append(join('..','..','bohrium','include', 'bohriumbridge.h'))
    multiarray_deps.append(join('..','..','bohrium','include', 'bohriumbridge_api.h'))
    multiarray_deps.append(join('..','..','bohrium','include', 'bohriumbridge_types.h'))
    umath_deps.append(join('..','..','bohrium','include', 'bohriumbridge.h'))
    umath_deps.append(join('..','..','bohrium','include', 'bohriumbridge_api.h'))
    umath_deps.append(join('..','..','bohrium','include', 'bohriumbridge_types.h'))
    bohrium_install_dir = join('..','..','..','..')#Default location
    try:
        bohrium_install_dir = os.path.abspath(os.environ['BH_INSTALL_DIR'])
    except KeyError:
        pass
    bohrium_install_dir = join(bohrium_install_dir, 'include')
    config.add_include_dirs(bohrium_install_dir)
