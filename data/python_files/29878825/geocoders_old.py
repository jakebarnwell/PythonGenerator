...
from overwrites import urlencode
...
class Google(WebGeocoder):
    ...
    def __init__(self, api_key=None, domain='maps.google.pl',
...
#        print "Fetching %s..." % url
    ...
    def parse_xml(self, page, exactly_one=True):
        ...
        def parse_place(place):
            ...
            exdata = place.getElementsByTagName("ExtendedData")[0]
            latlngboxs = exdata.getElementsByTagName("LatLonBox")[0]
            
            box = {
                'west': latlngboxs.attributes['west'].value,
                'south': latlngboxs.attributes['south'].value,
                'east': latlngboxs.attributes['east'].value,
                'north': latlngboxs.attributes['north'].value
            }
            ...
            return (location, (latitude, longitude), box)
