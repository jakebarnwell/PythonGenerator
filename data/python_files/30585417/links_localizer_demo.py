...
localizer.draw_trajectory([], mus=opt_mus[2:4,0:1], Sigmas=opt_Sigmas[2:4,2:4,0:1], color='green')
localizer.draw_trajectory([], mus=opt_mus[2:4,T-2:T-1], Sigmas=opt_Sigmas[2:4,2:4,T-2:T-1], color='green')
