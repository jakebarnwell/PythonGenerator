...
def create_notice_type(label, display, description, default=2, verbosity=1):
    ...
    try:
        ...
        if display != notice_type.display:
            ...
            updated = True
#        if description.__unicode__() != notice_type.description:
...
def send_now(users, label, extra_context=None, on_site=True, preference=None):
    ...
    for user in users:
        ...
        notice = Notice.objects.create(user=user, message=body_html,
        ...
        msg = EmailMultiAlternatives(subject, body_txt, settings.DEFAULT_FROM_EMAIL, [user.email,])
