...
from scheduled_mailer.models import Message, MessageLog
...
def prioritize():
    ...
    """
    for message in Message.objects.exclude(when_send__gt=datetime.datetime.now(), priority__lt=4).order_by("priority", "when_added")[:700]:
        yield message
