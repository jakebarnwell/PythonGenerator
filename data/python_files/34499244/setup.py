...
METADATA = {
    ...
    'description':      'Tesla comes back from death to take revenge',
    'author':           'Lucas Shrewsbury, Sebastian Lucas, Damian Uberti, Luciano Lombardi, Javier Krompeskfee',
    #'author_email':     '',
    'url':              'http://pyweek.org/e/tesla_revenge',
    'classifiers':      [
...
PACKAGEDATA = {
    ...
    'package_dir': {'tesla_revenge': 'tesla_revenge',
                   },
    'packages': ['tesla_revenge',
                ],
    'scripts': ['scripts/tesla_revenge'],
}
...
data_dirs = [os.path.join(f2.replace(_DATA_DIR, 'data')) for f2 in data]
PACKAGEDATA['package_data'] = {'tesla_revenge': data_dirs}
...
src = []
add_files(src,os.walk('tesla_revenge'))
