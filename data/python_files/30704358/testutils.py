...
import fvtest.fakedevice as fakedevice
...
def spawnFlowVisor(parent, config_file=CONFIG_FILE, fv_cmd="flowvisor", fv_args=["-d","DEBUG", "-l"]):
    """
...
def chkFlowdb(parent, controller_number, switch_number, exp_count):
    """
