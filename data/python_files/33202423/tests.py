...
from lake.theme.testing import LAKE_THEME_INTEGRATION_TESTING
from lake.theme.testing import LAKE_THEME_FUNCTIONAL_TESTING
...
class TestSetup(unittest.TestCase):
    ...
    layer = LAKE_THEME_INTEGRATION_TESTING

    def test_css_registry_configured(self):
        portal = self.layer['portal']
        cssRegistry = getToolByName(portal, 'portal_css')
        self.assertTrue("++theme++lake.theme/stylesheets/bootstrap.css"
                in cssRegistry.getResourceIds()
            )
        self.assertTrue("++theme++lake.theme/stylesheets/lake.css"
                in cssRegistry.getResourceIds()
            )
...
class TestRendering(unittest.TestCase):
    ...
    layer = LAKE_THEME_FUNCTIONAL_TESTING
